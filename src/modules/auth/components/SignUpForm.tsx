        ...
        {status === "verified" ? (
          ...
          >
            ...
            <h2 className="text-2xl font-sans font-bold text-[#112613] mb-4">
              ¡Todo listo en tu nido! 🐿️
            </h2>
            <p className="text-[#112613]/80 font-body mb-4">
              Tu cuenta ha sido confirmada exitosamente. Te llevaremos al inicio de sesión en <span className="font-bold text-moss-600">{redirectCountdown}</span> segundos para empezar a desenredar tus trámites...
            </p>
          </motion.div>
        ) : status === "success" ? (
          <motion.div 
          ...
          >
            ...
            <p className="text-[#112613]/80 font-body mb-4">
              Te enviamos un código de 6 dígitos a tu correo. Ingrésalo para que Lardi se ponga a trabajar en tus trámites. 🐿️
            </p>
          ...
          >
            ...
            <p className="text-acorn-600/90 font-body text-sm mb-8">
              Tú disfruta tus nueces. Lardi se encarga del papeleo. 🐿️⚖️
            </p>
            ...
            <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col gap-2">
                ...
                />
                <span className="text-xs text-acorn-600/80 font-medium mt-1">
                  Te enviaremos tu código de acceso para proteger tus trámites.
                </span>
              </div>
