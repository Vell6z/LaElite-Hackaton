...
const TYPEWRITER_TEXTS = [
  ...
  "Desenredando este trámite...",
  "Preguntándole a la ley qué está pasando...",
  "Lardi encontró un montón de papeles... auxilio.",
  "Revisando todo para que tú no tengas que hacerlo...",
  "Buscando qué toca hacer ahora...",
];
